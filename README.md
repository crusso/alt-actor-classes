...
This is a simple variation on the actor class example of Motoko that, instead of directly importing the actor class for Buckets, uses an intermediate factory actor to import and instantiate buckets.
...
To learn more before you start working with classes, see the following documentation available online:
